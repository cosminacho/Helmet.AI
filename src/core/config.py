...
# Set the class name
__C.YOLO.CLASSES = "./data/classes/ppe.names"
__C.YOLO.CLASSES_TINY = "./data/classes/helmet.names"
__C.YOLO.ANCHORS = "./data/anchors/yolov4_anchors.txt"
__C.YOLO.ANCHORS_V3 = "./data/anchors/yolov3_anchors.txt"
__C.YOLO.ANCHORS_TINY = "./data/anchors/tiny_anchors_v4.txt"
__C.YOLO.ANCHORS_TINY_V3 = "./data/anchors/tiny_anchors_v3.txt"
